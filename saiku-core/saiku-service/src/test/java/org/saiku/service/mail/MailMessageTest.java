...
class MailMessageTest {
    ...
    void requiredFields_areValidated() {
        assertThrows(NullPointerException.class,
                () -> new MailMessage(null, "from@x.com", "s", "b", List.of(), List.of()));
        assertThrows(NullPointerException.class,
                () -> new MailMessage("to@x.com", null, "s", "b", List.of(), List.of()));
    }

    @Test
    void carriesInlineImageAndAttachment() {
        MailMessage m = new MailMessage("to@x.com", "from@x.com", "s", "<img src=\"cid:chart\">",
