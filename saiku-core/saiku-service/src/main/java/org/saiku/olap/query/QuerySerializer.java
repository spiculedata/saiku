...
public class QuerySerializer {
    ...
    public String createXML() throws QueryParseException {
        if (this.query == null) throw new QueryParseException("Query object can not be null");
        ...
        try {
            if (axis.getLimitFunction() != null) {
                axisElement.setAttribute(
                        "limitFunction", axis.getLimitFunction().toString());
            }

            if (axis.getLimitFunctionN() != null) {
                axisElement.setAttribute(
                        "limitFunctionN", axis.getLimitFunctionN().toPlainString());
            }
        ...
        switch (axis.getLocation().axisOrdinal()) {
            ...
            default:
                throw new RuntimeException(
                        "Unsupported Axis-Ordinal: " + axis.getLocation().axisOrdinal());
        }
    }
}
