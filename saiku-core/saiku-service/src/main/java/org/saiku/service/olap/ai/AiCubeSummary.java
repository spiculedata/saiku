...
public class AiCubeSummary {
    ...
    public String getCubeCaption() { return cubeCaption; }
    public void setCubeCaption(String v) { this.cubeCaption = v; }
    public String getDefaultMeasure() { return defaultMeasure; }
    public void setDefaultMeasure(String v) { this.defaultMeasure = v; }
    public int getMeasureCount() { return measureCount; }
    public void setMeasureCount(int v) { this.measureCount = v; }
}
