	...
	<div class="admin">
		<div class="admin__tabs" role="tablist">
			...
			<button
				type="button"
				role="tab"
				class:active={tab === 'datasources'}
				onclick={() => (tab = 'datasources')}>{i18n.t('admin.tabs.datasources')}</button
			>
			<button
				type="button"
				role="tab"
				class:active={tab === 'schemas'}
				onclick={() => (tab = 'schemas')}>{i18n.t('admin.tabs.schemas')}</button
			>
			<button type="button" role="tab" class:active={tab === 'logs'} onclick={() => (tab = 'logs')}
				>{i18n.t('admin.tabs.logs')}</button
			>
			<button
				type="button"
				role="tab"
				class:active={tab === 'stats'}
				onclick={() => (tab = 'stats')}>{i18n.t('admin.tabs.stats')}</button
			>
			<button
				type="button"
				role="tab"
				class:active={tab === 'evals'}
				onclick={() => (tab = 'evals')}>Agent evals</button
			>
			<button
				type="button"
				role="tab"
				class:active={tab === 'spaces'}
				onclick={() => (tab = 'spaces')}>Agent spaces</button
			>
