...
<div
	class="flex min-h-0 flex-1 items-start justify-center px-4 py-10"
	role="region"
...
>
	<div class="card">
		...
		<div class="cta-row">
			...
			>
				<span class="mb-1 inline-flex items-center justify-center text-primary" aria-hidden="true">
					<BarChart3 size={28} strokeWidth={1.75} />
				</span>
				<span class="text-base font-semibold">Chart</span>
			...
			>
				...
				<span class="text-base font-semibold">Table</span>
			...
			>
				...
				<span class="text-base font-semibold">KPI</span>
		...
		<p class="more">
			...
			<strong>+ Add tile</strong> in the toolbar above for the full list. Filters are added in the
			<strong>Filters</strong> panel.
		</p>
	</div>
</div>
