...
<div class="gate">
	<div
		class="mb-3 inline-flex h-[40px] w-[40px] items-center justify-center rounded-md bg-success-soft text-success-strong"
	>
		<MailCheck size={20} />
	</div>
	...
	{:else}
		<form onsubmit={onVerify}>
			...
			<Button variant="outline" class="gate__back w-full" onclick={back} disabled={busy}>
